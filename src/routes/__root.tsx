...
(function() {
  try {
    var stored = localStorage.getItem('clarity-theme');
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  {
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300..900;1,9..144,300..900&family=Space+Grotesk:wght@400..700&display=swap",
  },
      {
        rel: "stylesheet",
        href: appCss,
